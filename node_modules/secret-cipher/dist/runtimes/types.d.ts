export declare const RUNTIME_NAMES: {
    readonly NODE: "node";
    readonly WEB: "web";
    readonly WEB_STANDARDS: "web-standards";
};
...
export type StandardSubtleCrypto = {
    ...
    importKey(format: 'raw', keyData: Uint8Array, algorithm: unknown, extractable: boolean, keyUsages: readonly string[]): Promise<unknown>;
